...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-xl border-t border-border bg-card/50 p-4 group-data-[size=sm]/card:p-3",
        className
      )}
      {...props}
    />
